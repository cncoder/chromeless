...
- editable def: send correct request to resave it
- editable def: receive correct request to resave it
* editable def: update valsi only if it has no "readonly" property
