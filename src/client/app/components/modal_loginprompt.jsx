            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        <p style={textStyle}>Please <Link onClick={this.closeModal} to="/login">login</Link> or <Link onClick={this.closeModal} to='/signup'>signup</Link> to submit content to almavlaste.</p>
